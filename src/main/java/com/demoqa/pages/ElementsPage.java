...
public class ElementsPage extends BasePage {
    ...
    public ElementsPage performKeyEventsWithRobot() {
        pause(1000);
        moveWithJS(uploadFileBtn, 0, 300);
        clickWithRectangle(uploadFileBtn, 10, 3);
        ...
        pause(1000);
        //press D(upper key as Shift key is pressed)
    ...
    public ElementsPage checkAllURL() {
        String url = "";
        System.out.println("Number of all links on the page: " + allLinks.size());
    ...
    public ElementsPage verifyCopyPasteText() {
        String[] current = currentAddressOutput.getText().split(":");
        String[] permanent = permanentAddressOutput.getText().split(":");
